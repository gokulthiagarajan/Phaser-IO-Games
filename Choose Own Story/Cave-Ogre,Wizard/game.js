...
function preload () {
  this.load.image('bg',     'https://gokulpublicassets.s3.us-east-2.amazonaws.com/background.png');
  this.load.image('knight', 'https://gokulpublicassets.s3.us-east-2.amazonaws.com/knight.png');
  //this.load.image('orc',    'https://gokulpublicassets.s3.us-east-2.amazonaws.com/orc.png');
  this.load.image('orc',    'https://gokulpublicassets.s3.us-east-2.amazonaws.com/shrek.png');
  this.load.image('wizard', 'https://gokulpublicassets.s3.us-east-2.amazonaws.com/wizard.png');
}
...
// Destroy before loading new page.
  ...
  optionBox.on('pointerup',function(){
    ...
    optionBox.on('pointerover',function(){
     ...
     optionBox.on('pointerout',function(){
      this.optionBox.setStrokeStyle(2, 0xb38c03, 1);
